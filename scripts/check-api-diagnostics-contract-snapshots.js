...
const fixturePaths = {
  clients: 'fixtures/api-contracts/clients-list.json',
  tenants: 'fixtures/api-contracts/tenants-list.json',
  plants: 'fixtures/api-contracts/plants-list.json',
  devices: 'fixtures/api-contracts/devices-list.json',
  alerts: 'fixtures/api-contracts/alerts-list.json',
  telemetry: 'fixtures/api-contracts/telemetry-list.json',
  integrations: 'fixtures/api-contracts/integrations-list.json'
};
