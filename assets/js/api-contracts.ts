...
(function () {
  ...
  const clients = createContract<ZentridClientDto>(CONTRACT_DEFINITIONS.clients, (row, _index, context) => {
    ...
    return {
      ...
      taxId: context.safeText(context.firstOf(row, ['generalInformation.taxIdVatNumber', 'generalInformation.taxId', 'taxIdVatNumber', 'taxId', 'tin', 'vat', 'taxNumber'], '—')),
  ...
  const tenants = createContract<ZentridTenantDto>(CONTRACT_DEFINITIONS.tenants, (row, _index, context) => {
    ...
    return {
      ...
      tax: context.safeText(context.firstOf(row, ['generalInformation.taxIdVatNumber', 'generalInformation.taxId', 'taxIdVatNumber', 'taxId', 'tin', 'vat', 'taxNumber'], '—')),
      ...
      platformNotifications: Boolean(context.firstOf(row, ['communicationPreferences.receivePlatformNotifications', 'communicationPreferences.platformNotifications', 'receivePlatformNotifications', 'platformNotifications'], false)),
      serviceNotifications: Boolean(context.firstOf(row, ['communicationPreferences.receiveServiceNotifications', 'communicationPreferences.serviceNotifications', 'receiveServiceNotifications', 'serviceNotifications'], false)),
      invoiceNotifications: Boolean(context.firstOf(row, ['communicationPreferences.receiveInvoiceNotifications', 'communicationPreferences.invoiceNotifications', 'receiveInvoiceNotifications', 'invoiceNotifications'], false)),
      securityNotifications: Boolean(context.firstOf(row, ['communicationPreferences.receiveSecurityNotifications', 'communicationPreferences.securityNotifications', 'receiveSecurityNotifications', 'securityNotifications'], false)),
