...
(function () {
  ...
  const FIELD_MAPPING_MANIFEST: Record<ZentridContractEntity, ZentridFieldMappingDefinition[]> = {
    ...
    tenants: [
      ...
      field('tenantName', ['vendorExtensions.tenantName', 'vendorExtensions.organizationName', 'vendorExtensions.displayName', 'vendorExtensions.name', 'generalInformation.tenantName', 'generalInformation.displayName', 'generalInformation.legalName',
      ...
      field('region', ['addressInformation.legalAddress.region', 'region', 'address.region', 'vendorExtensions.region'], ['Tenant Detail location'], 'text', '—'),
      ...
      field('email', ['contactPersons.contacts.0.email', 'contactEmail', 'email', 'contact.email'], ['Tenant Detail contacts'], 'email', '—'),
  ...
  const clients = createContract<ZentridClientDto>(CONTRACT_DEFINITIONS.clients, (row, _index, context) => {
    ...
    return {
      ...
      taxId: context.safeText(context.firstOf(row, ['generalInformation.taxId', 'taxId', 'tin', 'vat', 'taxNumber'], '—')),
      ...
      contactEmail: context.safeText(context.firstOf(row, ['contactPersons.contacts.0.email', 'contactEmail', 'email', 'contact.email'], '—')),
  ...
  const tenants = createContract<ZentridTenantDto>(CONTRACT_DEFINITIONS.tenants, (row, _index, context) => {
    ...
    return {
      ...
      region: context.safeText(context.firstOf(row, ['addressInformation.legalAddress.region', 'region', 'address.region', 'vendorExtensions.region'], '—')),
      city: context.safeText(context.firstOf(row, ['addressInformation.legalAddress.city', 'city', 'address.city', 'vendorExtensions.city'], '—')),
      address: context.safeText(context.firstOf(row, ['addressInformation.legalAddress.address', 'address', 'detailedAddress', 'addressLine', 'vendorExtensions.address'], '—')),
      ...
      tax: context.safeText(context.firstOf(row, ['generalInformation.taxId', 'taxId', 'tin', 'vat', 'taxNumber'], '—')),
      ...
      email: context.safeText(context.firstOf(row, ['contactPersons.contacts.0.email', 'contactEmail', 'email', 'contact.email'], '—')),
      ...
      businessSame: Boolean(context.firstOf(row, ['addressInformation.businessAddressSameAsLegal', 'businessAddressSameAsLegal'], false)),
      businessCountry: normalization.country(context.firstOf(row, ['addressInformation.businessAddress.country', 'businessCountry'], '—')),
      businessRegion: context.safeText(context.firstOf(row, ['addressInformation.businessAddress.region', 'businessRegion'], '—')),
      businessCity: context.safeText(context.firstOf(row, ['addressInformation.businessAddress.city', 'businessCity'], '—')),
      businessAddress: context.safeText(context.firstOf(row, ['addressInformation.businessAddress.address', 'businessAddress'], '—')),
      ...
      priority: context.safeText(context.firstOf(row, ['tenantClassification.priority', 'priority'], '—')),
      ...
      timezone: context.safeText(context.firstOf(row, ['communicationPreferences.timezone', 'timezone'], '—')),
      channel: context.safeText(context.firstOf(row, ['communicationPreferences.communicationChannel', 'communicationChannel'], '—')),
      businessHours: context.safeText(context.firstOf(row, ['communicationPreferences.businessHours', 'businessHours'], '—')),
      platformNotifications: Boolean(context.firstOf(row, ['communicationPreferences.platformNotifications', 'platformNotifications'], false)),
      serviceNotifications: Boolean(context.firstOf(row, ['communicationPreferences.serviceNotifications', 'serviceNotifications'], false)),
      invoiceNotifications: Boolean(context.firstOf(row, ['communicationPreferences.invoiceNotifications', 'invoiceNotifications'], false)),
      securityNotifications: Boolean(context.firstOf(row, ['communicationPreferences.securityNotifications', 'securityNotifications'], false)),
      ...
      dpa: context.safeText(context.firstOf(row, ['legalCompliance.dataProcessingAgreementStatus', 'dataProcessingAgreementStatus'], '—')),
      ...
      consentExpiry: context.safeText(context.firstOf(row, ['legalCompliance.consentExpiryDate', 'consentExpiryDate'], '—')),
